...
- ✅ **Safety & Liveness**: Correctness properties in consensus algorithms
- ✅ **PBFT**: The classic three-phase BFT protocol with O(n²) complexity
- ✅ **HotStuff 2.0**: Modern BFT with O(n) linear communication complexity
...
git clone https://github.com/study-ab/study-ab.git
cd study-ab
...
- **[Glossary](docs/resources/glossary.md)**: All BFT terminology
- **[References](docs/resources/references.md)**: Academic papers, articles
- **[Getting Started](GETTING-STARTED.md)**: Detailed learning guide
